///Diese using-Anweisung einfügen und zuvor als Verweis laden
using Excel = Microsoft.Office.Interop.Excel;  
namespace Verteilung  //namespace beachten
{
class MsExcel
{   
#region Variablen
...
Excel.Worksheet worksheed;      //Tabelle
...
public void openSheed(string tableName)
{
    ...
    worksheed = workbook.Worksheets["Tabelle1"]; //Tabelle1 ist aktuell
...
public void openSheed(string filePath, string tableName)
{
    ...
    worksheed = workbook.Worksheets[tableName]; //Tabelle tableName ist aktuell
}
#endregion Excel
...
public void headRowToSheed(params string[] headRow)
{
    for (int spalte = 0; spalte < headRow.Length; spalte++)
        worksheed.Cells[1, spalte + 1] = headRow[spalte];
}
/// <summary>
...
public void toSheed(int zeile, int spalte, object value)
{
    ...
    worksheed.Cells[zeile + 2, spalte + 1] = value;
}
/// <summary>
...
public string[] headRowFromSheed(int spaltenAnzahl)
{
    ...
    for (int spalte = 0; spalte < spaltenAnzahl; spalte++)
        ...
        headRow[spalte]=worksheed.Cells[1, spalte + 1];
    return headRow;
}
/// <summary>
...
public object FromSheed(int zeile, int spalte)
{
    ...
    //+1 für die Datenzeile, da eine Zeile für den Tabellenkopf
    //Excel-Zellen kennen den Typ object
    return worksheed.Cells[zeile + 2, spalte + 1].Value;;
}
/// <summary>
